...
(function (h) {
    ...
    function Fa(a) {
        ...
        if (d || (!t && !f && !e && j == V(a) && j == m.length)) for (n = 0; n < j; n++) (i = aa(a, n)), null !== i && (c[i].sWidth = v(m.eq(n).width()));
            ...
            for (n = 0; n < i.length; n++) (o = c[i[n]]), (m[n].style.width = null !== o.sWidthOrig && '' !== o.sWidthOrig ? v(o.sWidthOrig) : ''), o.sWidthOrig && f && h(m[n]).append(h('<div/>').css({ width: o.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
    ...
    n.ext = x = { buttons: {}, classes: {}, builder: '-source-', errMode: 'alert', feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {}, header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: n.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: n.version };
